//error has a state 61, eof has state 60, e has 1100, end of tokens in first_follow -100
//error is doing an extra increment(), try doing that only for state 0 errors
//$ is not recognized in lexer, only to be usesd later
#include <stdlib.h>
#include <stdio.h>
#include "lexer.h"
